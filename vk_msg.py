            ...
            if event.to_me:
                ...
                if message in ('привет', 'старт', 'начать'):
                    ...
                    vkbot.message_send(event.user_id, f'Привет, {name_bot_user}!\n'
                                                      ...
                                                      ' 2 - добавляем партнера в черный список.\n'
                                                      ' 3 - посмотреть избранного партнера.\n'
                                                      ' 4 - посмотреть черный список.\n'
                    ...
                    vkbot.message_send(event.user_id, 'Список избранного очищен')
                    ...
                    vkbot.message_send(event.user_id, 'До свидания!')

                else:
                    vkbot.message_send(event.user_id, "Команда не опознана")
